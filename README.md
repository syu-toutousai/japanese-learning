...
| [`kenrui-courseware/`](./kenrui-courseware/) | 兼类词（名词・形容动词）・両刀ポケット：动词连用形/动作名词「再加な 当形容词」的词——おすすめな商品・控えめな態度・場違いな服装。27 词分 5 大语义场，标注「新兴口语委词典级」并附黄金法则（动作→の，属性→な），数据存 `kenrui.json` 随手增删，重建即自动长卡片、TTS 发音与三层题库＋错题本，单文件 HTML 离线可用 |
