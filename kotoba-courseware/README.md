...
当前词条：**風情（ふぜい）** ・ **開く・あく（🕳️）** ・ **はしゃぐ（🎉）** —— 顶部可切换任一新词，各自独立初见→语义网络→辨析→提取→间隔复习。

成品是单文件 `index.html`（约 3MB，内嵌全部发音 + 番剧台词原声与画面，离线可用），数据在 `kotoba.json`。
...
- **发音 40 段**：单词・例句原声（MOJi/edge-tts：Nanami 女生 / Keita 男生）＋
  **Nadeshiko 台词・画面 11 段** 原声 MP3＋画面帧，见「🎬 台词·画面」页（風情 6 段 / あく 2 段 / はしゃぐ 3 段）
- **题库**：詞義認識 12 ・産出填空 6・聴解判別 3・辨析判別 9・自作 9 ＝ 39 問 ＋ 混合交错 ＋ 错题本
